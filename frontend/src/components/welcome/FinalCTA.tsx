...
export default function FinalCTA() {
  return (
    <section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto rounded-[32px] sm:rounded-[40px] bg-[#111611] text-white py-16 sm:py-24 px-6 sm:px-12 text-center relative overflow-hidden shadow-2xl border border-[#243524]">
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <span className="text-xs font-bold tracking-widest text-emerald-400/90 uppercase block mb-4">
          ...
          <h2 className="font-heading font-extrabold text-4xl sm:text-6xl tracking-tight leading-tight mb-6">
            ...
            <span className="text-emerald-400 not-italic">Move.</span>
          </h2>
          ...
          <Link
            to="/signup"
            className="inline-flex items-center gap-3 bg-white text-slate-950 px-8 py-4 rounded-full font-heading font-extrabold text-base transition-all duration-200 hover:bg-emerald-400 hover:scale-105 shadow-xl hover:shadow-emerald-500/20"
          >
